...
%*** Un peu, à besoin d'encore un peu de travail *** modifié encore un peut (surtout la partie sur l'apprentissage. également séparé les différentes parties, si c'est toujours imprecis pouvez vous m'indiquer quelle parties le sont? ***
...
\begin{figure}[t]
\centering
%*** penser à refaire les strips avec le mm nbr d'image et le mm taille pr chaque image***
