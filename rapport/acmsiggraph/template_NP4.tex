...
%*** Revoir cette première phrase, surement du mauvais copier/coller ***
...
%*** La phrase ci-dessus n'est pas claire, la retravailler ***
...
%***trouver un autre mot que simple (genre elementary ou unitary) ou carément  enlever le simple
...
%*** Add number (or size) of finite elements ***
